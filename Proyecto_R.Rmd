...
Podemos poner en juicio esta teoría con el siguiente bucle. Nos indica: 
Si el valor absoluto de la diferencia entre la temperatura y la temperatura de rocío es menor que 5, entonces define 'index' igual al índice en que esto ocurra. En caso contrario asigna un valor nulo a 'index'.
